...
st.set_page_config(page_title= "Industrial Copper Modelling | By Nahid Banu",
                   page_icon= icon,
                   layout= "wide",
...
st.markdown("<div class='box'><h1 style='text-align: center; color:Brown; font-size:50px;'>Industrail Copper Modelling</h1></div>", unsafe_allow_html=True)
...
# # Background image
background_image_url = "https://images.pexels.com/photos/235985/pexels-photo-235985.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2.jpg"
...
if selected == "Home":
    ...
    st.markdown('<p style="font-size: 33px; color: black;">Copper is an extremely versatile metal with a long history of making the world work better.</p>', unsafe_allow_html=True)

    st.markdown('<p style="font-size: 33px; color: black;">Copper has electrical, thermal conductivity & antimicrobial properties  </p>', unsafe_allow_html=True)
    st.markdown('<p style="font-size: 33px; color: black;"> Copper can be recycled without any loss in properties, making it a logical choice in an era of global sustainability.  </p>', unsafe_allow_html=True)
    st.markdown('<p style="font-size: 33px; color: black;"> The copper industry deals with less complex data related to sales and pricing </p>', unsafe_allow_html=True)
    st.markdown('<p style="font-size: 33px; color: black;"> but data may suffer from issues such as skewness and noisy data, that has to be treated for outliers </p>', unsafe_allow_html=True)
    # st.markdown('<p style="font-size: 30px; color: blue;">   </p>', unsafe_allow_html=True)
